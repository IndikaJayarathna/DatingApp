...
namespace Dating.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            var photo = await _context.Photos.FirstOrDefaultAsync(p => p.Id == id);   // go to context and pass the item which match for id
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            if (userParams.Likees) // get Ids that logged in user liked
            {
        ...
        private async Task<IEnumerable<int>> GetUserLikes(int id, bool likers)
        {
            ...
            if (likers) // check passing bool Likers true or flse
            {
                return user.Likers.Where(u => u.LikeeId == id).Select(i => i.LikerId); // select used to return colloection of int ot id
            }
            else
            {
